...
// Todo 1: Component สำหรับส่วน <header>
function Header() {
  return (
    <header>
      <nav>
...
// Todo 2: Component สำหรับส่วน <main>
  ...
  return (
    <main>
      <div className="company-detail-left">
        ...
        <img src="https://placehold.co/300x300" alt="Company Hero" />
      </div>
...
// Todo 5 & 6: Component สำหรับปุ่ม Add to Cart พร้อมเปลี่ยน className เป็น "-secondary"
function Button() {
  return (
...
// Todo 3: Component สำหรับส่วน <section className="product-section">
...
// Todo 4: Component สำหรับส่วน <footer>
function Footer() {
  return (
    <footer>
